...
def main():
    with sync_playwright() as p:
        ...
        page.wait_for_timeout(4000)
        page.screenshot(path=str(OUT_DIR / "screenshots" / "astor_apos_consultar.png"), full_page=True)
        (OUT_DIR / "dumps" / "astor_apos_consultar.html").write_text(page.content(), encoding="utf-8")
        print("done")
